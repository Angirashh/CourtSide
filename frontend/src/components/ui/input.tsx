  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        ...
        ref={ref}
        className={cn(
          'flex h-11 w-full rounded-lg border border-navy-200 bg-cream-25 px-3.5 text-base text-navy-900 sm:text-sm placeholder:text-navy-400 shadow-sm transition-colors',
